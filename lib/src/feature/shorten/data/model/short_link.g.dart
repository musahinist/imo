...
part of 'short_link.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ShortLinkAdapter extends TypeAdapter<ShortLink> {
  @override
  final int typeId = 0;

  @override
  ShortLink read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, ShortLink obj) {
    writer
      ..writeByte(8)
      ..writeByte(0)
      ..write(obj.code)
